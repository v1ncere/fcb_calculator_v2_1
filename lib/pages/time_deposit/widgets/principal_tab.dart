                    ...
                    child: Column(
                      children: [
                              ...
                              onPressed: () {
                                setState(() {
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    double r = double.parse(_timeAnnualInterestRateTF.text)/100.0;
                                    double n = double.parse(_timeYearsTF.text);

                                    _timePresentValue = (F/(1+(r*n))).toStringAsFixed(2);
                                    // SHOW RESULT DIALOG
                                    showGeneralDialog(
                                      ...
                                      pageBuilder: (_, __, ___) {
                                        return PrincipalDialog(timePresentValue: _timePresentValue);
                                      },
                        ...
                        Container(
                          padding: const EdgeInsets.all(3),
                          width: MediaQuery.of(context).size.width,
                          child: Text('Example: You are to bring the total amount of savings to P710.00 in 7 years. Your annual interest rate is 6.0%. How much principal must be invested to reach your goal? (Ans: P500.00)',
