...
class _InterestRateTabState extends State<InterestRateTab> {
  ...
  int _compounding = 12;
  String _savingsAnnualInterestRate = '';
                    ...
                    child: Column(
                      children: [
                              ...
                              onPressed: () {
                                setState(() {
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    _savingsAnnualInterestRate = (((pow(F/P, 1/period)-1)*_compounding)*100).toStringAsFixed(2);
                                    ...
                                    showGeneralDialog(
                                      ...
                                      pageBuilder: (_, __, ___) {
                                        return InterestRateDialog(savingsAnnualInterestRate: _savingsAnnualInterestRate);
                                      },
                        ...
                        Container(
                          padding: const EdgeInsets.all(3),
                          width: MediaQuery.of(context).size.width,
                          child: Text('Example: You are going to invest P6,000. To increase this amount to P10,000 in 10 years, what interest rate is necessary for a savings account compounded monthly? (Ans: 5.12% p.a.)',
                            textAlign: TextAlign.left,
                            style: TextStyle(
